...
//
    public AddStudent()
    {
        ...
        Image i3 = img.getImage().getScaledInstance(1180, 700,Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        id15.setIcon(icc3);

        id8 = new JLabel("New Student Details");
        id8.setBounds(320,30,500,50);
        id8.setFont(new Font("serif",Font.ITALIC,28));
        id8.setForeground(Color.darkGray);
        id15.add(id8);
        f.add(id15);
//
...
//
    public void actionPerformed(ActionEvent ae)
    {
        ...
        String c = t3.getText();
        String d = t4.getText();       // taking input from textfields
        String e = t5.getText();
        ...
        String l = (String)c1.getSelectedItem();      // taking input from comboBox
        String m = (String)c2.getSelectedItem();
        
        if(ae.getSource() == b)        // b is submit button
        {
            try
            {
                conn cc = new conn();
                String q = "insert into student values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+l+"','"+m+"','"+k+"')";
        ...
        else if(ae.getSource() == b1)       // b1 is cancel button
        {
            f.setVisible(false);

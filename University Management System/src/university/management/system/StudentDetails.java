...
//
        ...
        try
        {
            ...
            t1 = new JTable(y,x);     // creating onject of table and adding 2d-array(y) and 1d-array(x) in it
        ...
        add(sp);
//
        getContentPane().setBackground(Color.WHITE);   // content pane means container

...
public class EnterMarks extends JFrame implements ActionListener{
    ...
    EnterMarks(){
        ...
        l3.setBounds(90,155,200,40);
        add(l3);

        l4 = new JLabel("MARKS");
        l4.setBounds(290,155,200,40);
        add(l4);

        t2 = new JTextField();
        t2.setBounds(45,200,200,20);
        add(t2);

        t3 = new JTextField();
        t3.setBounds(245,200,200,20);
        add(t3);

        t4 = new JTextField();
        t4.setBounds(45,230,200,20);
        add(t4);

        t5 = new JTextField();
        t5.setBounds(245,230,200,20);
        add(t5);

        t6 = new JTextField();
        t6.setBounds(45,260,200,20);
        add(t6);

        t7 = new JTextField();
        t7.setBounds(245,260,200,20);
        add(t7);

        t8 = new JTextField();
        t8.setBounds(45,290,200,20);
        add(t8);

        t9 = new JTextField();
        t9.setBounds(245,290,200,20);
        add(t9);

        t10 = new JTextField();
        t10.setBounds(45,320,200,20);
        add(t10);

        t11 = new JTextField();
        t11.setBounds(245,320,200,20);
        add(t11);

        b1 = new JButton("Submit");
        b1.setBounds(190,360,100,30);
